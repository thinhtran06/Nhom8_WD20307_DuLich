...
$routes = [
    ...
    'guide_schedule'         => ['Guide', 'schedule', true],      // Xem lịch làm việc
    'guide_tour_detail'      => ['Guide', 'tourDetail', true],    // Xem chi tiết tour được giao
    'guide_diary'            => ['GuideDiary', 'index', true],    // Xem danh sách nhật ký
    'guide_diary_add'        => ['GuideDiary', 'add', true],      // Thêm nhật ký mới
    'guide_diary_store'      => ['GuideDiary', 'save', true],     // Lưu nhật ký
];
