...
public function create() {
        // LỖI Ở ĐÂY: Phải thêm guide_id=:guide_id vào câu SET
        ...
        $this->guide_id = !empty($this->guide_id) ? htmlspecialchars(strip_tags($this->guide_id)) : null;
        ...
        // Bind dữ liệu (Đảm bảo số lượng Bind khớp với số lượng : tham số ở trên)
    ...
    public function update() {
        // THÊM guide_id=:guide_id vào câu lệnh UPDATE
        ...
        $this->id = htmlspecialchars(strip_tags($this->id));
        $this->guide_id = !empty($this->guide_id) ? htmlspecialchars(strip_tags($this->guide_id)) : null;
        // ... (các bước làm sạch khác giữ nguyên như create)
