            ...
            ?>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?action=tour_request_detail&id=<?= $request['id'] ?>" class="btn btn-info btn-sm">Xem chi tiết</a>

                            <a href="index.php?action=tour_request_edit&id=<?= $request['id'] ?>" class="btn btn-warning btn-sm">Sửa</a>

                            <form action="index.php?action=tour_request_delete" method="POST" style="display:inline-block;">
                                <input type="hidden" name="id" value="<?= $request['id'] ?>">
                                <button class="btn btn-danger btn-sm" onclick="return confirm('Xóa yêu cầu này?');">Xóa</button>
                            </form>
                        </td>
